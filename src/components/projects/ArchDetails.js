...
import styles from "./ArchDetails.module.css";

const ArchDetails = (props) => {
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles["office-container"]}>
        ...
        <p className={styles["office"]}>Office: {details.company}</p>
      ...
      {props.data.details.url && (
        <div className={styles["url-container"]}>
          <div className={styles["dot"]} style={{ width: "2.4rem" }} />
          <a href={details.url} className={styles["url"]}>
            {details.url}
          </a>
          <div className={styles["vertical-line"]} style={{ height: "100%" }} />
        </div>
